      ...
      <section className="mx-auto max-w-4xl px-5 py-16 sm:px-8">
        ...
        <div className="mt-8 rounded-2xl border border-amber-200 bg-amber-50 p-6 text-amber-950">
          ...
          <p className="mt-2 text-sm leading-6">
            Risk signals do not prove that a listing or person is fraudulent.
            Verify the opening through the employer&apos;s official website or a
            phone number you found independently.
          </p>
        </div>
        <Link
          href="/"
          className="mt-8 inline-flex font-semibold text-teal-800 underline decoration-teal-300 underline-offset-4"
        >
